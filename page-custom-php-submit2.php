...
//function sinetiks_schools_list() {
		echo site_url('page-custom-php-update');
    ?>
    ...
    <div class="wrap">
        ...
        <div class="tablenav top">
            <div class="alignleft actions">
				...
				<a href="<?php echo site_url('custom-php-add'); ?>">Add New2</a>
            </div>
            <br class="clear">
        </div>
        <?php
            ...
            <?php foreach ($rows as $row) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo admin_url('admin.php?page=sinetiks_schools_update&id=' . $row->id); ?>">Update</a></td>
             		<td><a href="<?php echo site_url('custom-php-update?id=' . $row->id); ?>">Update2</a></td>
                </tr>
            <?php } ?>
        </table>
    </div>
